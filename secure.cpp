...
int main()
{
	...
	str = "%25%25%25%27eval  ('some code') <    img     style=\"12<3\"  >sadfsafsadf</>sadfdsfsdafas<img style='asdfsad'&nbsp&yuml/><img style='asdfsad'&nbsp&yuml/> &nbsp=asdfsad&style=asdfsad&style=asdfsad&style=asdfsad&#x1231∏ /><script></script><a href=asdfsdafdsaalert|&#40;d  a  t  a  :></a>";
	std::cout<<antiFilter::remove_xss(str)<<"\n";
